		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Freestyle Demo App",
									"targetURL": "#ui5odatav2demo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5odatav2demo-display": {
								"semanticObject": "ui5odatav2demo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5odatav2demo",
									"url": sap.ui.require.toUrl("ui5odatav2demo")
								}
							}
						}
					}
